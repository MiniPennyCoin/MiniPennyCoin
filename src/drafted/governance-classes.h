 ...
 *
 *   // network
 *   CMiniPennyCoinNetwork lvl, network-type, network-status, network-error, milestone-status*
...
private:
    ...
    // Current OBJECT STATUS (see http://govman.MiniPennyCoin.org/index.php/Documentation_:_Status_Field)
    int nStatusID;
...
// // root node
class CMiniPennyCoinNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CMiniPennyCoinNetwork(UniValue objIn)
    {
...
// // can be under: MiniPennyCoinNetwork
// //   -- signature requirements : Key1(User)
// class CMiniPennyCoinNetworkVariable : public CGovernanceObject
// {
// private:
...
//     //     return (IsType() == MiniPennyCoinNetwork);
//     // }
