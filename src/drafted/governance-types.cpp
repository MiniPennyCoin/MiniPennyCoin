...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "MiniPennyCoinNetwork") type = MiniPennyCoinNetwork;
    if(strType == "MiniPennyCoinNetworkVariable") type = MiniPennyCoinNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == MiniPennyCoinNetwork) s = "MiniPennyCoinNetwork";
    if(type == MiniPennyCoinNetworkVariable) s = "MiniPennyCoinNetworkVariable";
