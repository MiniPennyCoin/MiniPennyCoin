    ...
    platformStyle(platformStyle)
{
    ...
    QString windowTitle = tr("MiniPennyCoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a MiniPennyCoin address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and MiniPennyCoin: URIs)"));
    ...
    aboutAction = new QAction(QIcon(":/icons/" + theme + "/about"), tr("&About MiniPennyCoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about MiniPennyCoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for MiniPennyCoin Core"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your MiniPennyCoin addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/" + theme + "/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified MiniPennyCoin addresses"));
    ...
    openAction->setStatusTip(tr("Open a MiniPennyCoin: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the MiniPennyCoin Core help message to get a list with possible MiniPennyCoin Core command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("MiniPennyCoin Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::updateNetworkState()
{
    ...
    if (clientModel->getNetworkActive()) {
        labelConnectionsIcon->setToolTip(tr("%n active connection(s) to MiniPennyCoin network", "", count));
    } else {
...
{
    QString strTitle = tr("MiniPennyCoin Core"); // default title
    ...
    // Append title to "MiniPennyCoin Core - "
    if (!msgType.isEmpty())
        strTitle += " - " + msgType;
