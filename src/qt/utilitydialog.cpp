    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("MiniPennyCoin Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About MiniPennyCoin Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  MiniPennyCoin-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the MiniPennyCoin in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 MPC, 0.1 MPC, 1 MPC and 10 MPC -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("MiniPennyCoin Core is shutting down...") + "<br /><br />" +
