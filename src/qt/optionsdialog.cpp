    ...
    mapper(0)
{
    ...
    /* Theme selector */
    ui->theme->addItem(QString("MPC-light"), QVariant("light"));
    ui->theme->addItem(QString("MPC-light-hires"), QVariant("light-hires"));
    ui->theme->addItem(QString("MPC-blue"), QVariant("drkblue"));
    ui->theme->addItem(QString("MPC-Crownium"), QVariant("crownium"));
    ui->theme->addItem(QString("MPC-traditional"), QVariant("trad"));
