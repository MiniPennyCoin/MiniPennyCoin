...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || mapArgs.count("-?") || mapArgs.count("-h") || mapArgs.count("-help"))
    {
        ...
        std::string strUsage = _("MiniPennyCoin Core MiniPennyCoin-tx utility version") + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  MiniPennyCoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded MiniPennyCoin transaction") + "\n" +
              "  MiniPennyCoin-tx [options] -create [commands]   " + _("Create hex-encoded MiniPennyCoin transaction") + "\n" +
              "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded MiniPennyCoin transaction
