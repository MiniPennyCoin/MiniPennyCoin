...
#define BOOST_TEST_MODULE MiniPennyCoin Test Suite

#include "test_MiniPennyCoin.h"
...
#endif
        ClearDatadirCache();
        pathTemp = GetTempPath() / strprintf("test_MiniPennyCoin_%lu_%i", (unsigned long)GetTime(), (int)(GetRand(100000)));
