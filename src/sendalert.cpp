...
2. run MiniPennyCoind with -printalert or -sendalert like this:
   /path/to/MiniPennyCoind -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.MiniPennyCoin.org";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/MiniPennyCoin Core:0.12.0.58/"));
